...
public class SecurityConfig {
  ...
  // configurado em NimbusCoreProxyProperties (NIMBUS_INTERNAL_API_SECRET, usado hoje só pra
  // CHAMAR o NimbusCore/NimbusFlow) - nenhuma env var nova. @Order menor que apiChain (10) e
